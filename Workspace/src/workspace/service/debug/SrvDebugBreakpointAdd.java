...
public class SrvDebugBreakpointAdd extends SrvGenerique
{
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response, BeanGenerique bean)
        throws Exception
    {
        throw new Error("Unresolved compilation problems: \n\tThe method createVirtualMachine(String, Integer) from the type UtilJDI refers to the missing type VirtualMachine\n\tThe method createBreakpointRequest(VirtualMachine, String, Integer) from the type UtilJDI refers to the missing type BreakpointRequest\n");
    }
        ...
        throws Exception
    {
        ...
        {
            request.setAttribute("msgText", result);
        }
    }
}
