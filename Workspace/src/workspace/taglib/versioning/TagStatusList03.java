...
// Source File Name:   TagStatusList03.java
...
public class TagStatusList03 extends BodyTagSupport
{
    ...
    private void copyListIntoVectorAt(File rootFile, Object list[], List vecStatus, Hashtable tabStatus, int at, int beanIndex)
        throws IOException
    {
        throw new Error("Unresolved compilation problem: \n");
    }
