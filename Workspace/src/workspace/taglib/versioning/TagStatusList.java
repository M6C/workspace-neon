...
// Source File Name:   TagStatusList.java
...
public class TagStatusList extends BodyTagSupport
{
    ...
    private void copyListIntoVectorAt(File rootFile, Object list[], List vecStatus, Hashtable tabStatus, int at, int beanIndex, boolean bIncludeIgnored)
        throws IOException
    {
        throw new Error("Unresolved compilation problem: \n");
    }

    private void initStatusInformation(Hashtable beanList, StatusInformation statusList[], File root)
        throws IOException
    {
        throw new Error("Unresolved compilation problem: \n");
    }
    ...
    private String includeSubDirectory;
    private String includeIgnored;
