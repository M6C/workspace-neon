...
<html>
    ...
    <body bgcolor="buttonface">
        <form action="action.servlet">
          <input type="hidden" name="event" value="AdminPageExecShutdownValider"/>
	    	<table>
		    	<tr>
			    	<td align="center">
...
--%>
						<input type="text" name="commandLine" size="40" value="D:/Dev/Travaux/Java/JBuilder8/exe/rebooter_shutdown.bat"/>
