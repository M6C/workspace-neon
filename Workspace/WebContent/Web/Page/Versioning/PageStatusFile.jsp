...
<html>
    <head>
        <title>
	        ...
	        <!--link href="<%=DOMAIN_NAME_ROOT%>/css/page/versioning/pagestatusfile.css" rel="stylesheet" type="text/css"-->
        <jsp:include page="/css/page/versioning/pagestatusfile.jsp" flush="true"/>
		<script language="javascript" src="<%=DOMAIN_NAME_ROOT%>/js/page/versioning/pagestatusfile.js" type="text/javascript"></script>
	</head>
	<body>
		<form action="action.servlet">
			<input type="hidden" name="event" value="VersionStatusFileValider"/>
