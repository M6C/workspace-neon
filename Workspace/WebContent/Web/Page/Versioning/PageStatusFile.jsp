...
<html>
    <head>
        <title>
	        ...
	        <!--link href="/WorkSpace/css/page/versioning/pagestatusfile.css" rel="stylesheet" type="text/css"-->
        <jsp:include page="/css/page/versioning/pagestatusfile.jsp" flush="true"/>
		<script language="javascript" src="/WorkSpace/js/page/versioning/pagestatusfile.js" type="text/javascript"></script>
	</head>
	<body>
