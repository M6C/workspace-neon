...
<html>
	<head>
		<title>
	        ...
	        <!--link href="<%=DOMAIN_NAME_ROOT%>/css/page/versioning/pageaddfile.css" rel="stylesheet" type="text/css"-->
        <jsp:include page="/css/page/versioning/pageaddfile.jsp" flush="true"/>
		<script language="javascript" src="<%=DOMAIN_NAME_ROOT%>/js/page/versioning/pageaddfile.js" type="text/javascript"></script>
	</head>
	<body>
