...
<html>
    <head>
        <title>
	        ...
	        <!--link href="/WorkSpace/css/page/versioning/pagecommitfile.css" rel="stylesheet" type="text/css"-->
        <jsp:include page="/css/page/versioning/pagecommitfile.jsp" flush="true"/>
		<script language="javascript" src="/WorkSpace/js/page/versioning/pagecommitfile.js" type="text/javascript"></script>
	</head>
	<body>
