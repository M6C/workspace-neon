...
<html>
	<head>
		<title>
	        ...
	        <!--link href="<%=DOMAIN_NAME_ROOT%>/css/page/versioning/pageignoredel.css" rel="stylesheet" type="text/css"-->
        <jsp:include page="/css/page/versioning/pageignoredel.jsp" flush="true"/>
		<script language="javascript" src="<%=DOMAIN_NAME_ROOT%>/js/page/versioning/pageignoredel.js" type="text/javascript"></script>
	</head>
	<body>
