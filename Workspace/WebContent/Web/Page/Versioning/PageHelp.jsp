...
<html>
    <head>
        <title>
	        ...
	        <!--link href="<%=DOMAIN_NAME_ROOT%>/css/page/versioning/pageimport.css" rel="stylesheet" type="text/css"-->
        <jsp:include page="/css/page/versioning/pageimport.jsp" flush="true"/>
		<script language="javascript" src="<%=DOMAIN_NAME_ROOT%>/js/page/versioning/pageimport.js" type="text/javascript"></script>
	</head>
	<body>
