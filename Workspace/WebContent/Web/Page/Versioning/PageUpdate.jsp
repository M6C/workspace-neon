...
<html>
    <head>
        <title>
	        ...
	        <!--link href="<%=DOMAIN_NAME_ROOT%>/css/page/versioning/pageupdate.css" rel="stylesheet" type="text/css"-->
        <jsp:include page="/css/page/versioning/pageupdate.jsp" flush="true"/>
		<script language="javascript" src="<%=DOMAIN_NAME_ROOT%>/js/page/versioning/pageupdate.js" type="text/javascript"></script>
	</head>
	<body>
