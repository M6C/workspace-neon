...
<html>
    <head>
        <title>
	        ...
	        <!--link href="/WorkSpace/css/page/versioning/pagecheckout.css" rel="stylesheet" type="text/css"-->
        <jsp:include page="/css/page/versioning/pagecheckout.jsp" flush="true"/>
		<script language="javascript" src="/WorkSpace/js/page/versioning/pagecheckout.js" type="text/javascript"></script>
	</head>
	<body>
