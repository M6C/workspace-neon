...
<html>
    <head>
        <title>
	        ...
	        <!--link href="/WorkSpace/css/page/versioning/pageupdfile.css" rel="stylesheet" type="text/css"-->
        <jsp:include page="/css/page/versioning/pageupdfile.jsp" flush="true"/>
		<script language="javascript" src="/WorkSpace/js/page/versioning/pageupdfile.js" type="text/javascript"></script>
	</head>
	<body>
		<form action="action.servlet">
			<input type="hidden" name="event" value="VersionUpdDirectoryValider"/>
