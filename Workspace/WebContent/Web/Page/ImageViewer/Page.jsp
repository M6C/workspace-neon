...
--%>
    	...
    	<!--link href="/WorkSpace/css/page/imageviewer/page.css" rel="stylesheet" type="text/css"-->
        ...
        <script language="javascript" src="/WorkSpace/js/page/imageviewer/page.js" type="text/javascript"></script>
