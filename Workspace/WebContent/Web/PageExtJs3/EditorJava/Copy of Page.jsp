		...
		*/
		...
		var viewport = new Ext.Viewport({
            ...
            new Ext.BoxComponent({
                ...
                items: [{
                    contentEl: 'west-project',
                    title: 'Project',
                    border: false,
                    iconCls: 'proj',
                    collapsible: true// see the HEAD section for style used
                },/* {
                    contentEl: 'west-directory',
                    title: 'Directory',
                    border: false,
                    iconCls: 'dir' // see the HEAD section for style used
                }*/tree, {
                	contentEl: 'west-file',
                    title: 'File',
                    border: false,
...
<body>
    ...
    <div id="west-project" class="x-hide-display">
...
<%--
    <div id="west-directory" class="x-hide-display">
        <p>Directory.</p>
    </div>
--%>
    <div id="west-file" class="x-hide-display">
        <p>File.</p>
    </div>
    <div id="center2" class="x-hide-display">
        <a id="hideit-east" href="#">Toggle the east region</a>
        <a id="hideit-west" href="#">Toggle the west region</a>
